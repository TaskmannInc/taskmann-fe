...
import { BsFillCheckCircleFill, BsTelephoneInbound } from "react-icons/bs";
import {
  MdCancel,
...
import { UpdateCustomerBioDataHook } from "../../../../utils/hooks/customerAuth";
import { ContextStore } from "../../../../../store/contextStore";

export default function ClientProfileInformation({ styles, session }) {
  ...
  const {
    ...
    error,
    isSuccess,
  } = UpdateCustomerBioDataHook(onSuccess, onError);
