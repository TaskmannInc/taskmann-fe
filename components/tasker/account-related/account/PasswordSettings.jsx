...
import { StafdPasswordChangeDataHook } from "../../../utils/hooks/adminAuth";

export default function StaffPasswordSettings({ styles, session }) {
  //component states
  ...
  const {
    ...
    error,
    isSuccess,
  } = StafdPasswordChangeDataHook(onSuccess, onError);
  ...
  return (
    <>
      ...
      <div className={styles.staffPasswordSettings}>
